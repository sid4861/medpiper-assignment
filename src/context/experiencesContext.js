...
const experiencesReducer = (state, action) => {
    switch (action.type) {
        ...
        case "add_special_assignment_served":
            return {...state,
                specialAssignmentsServed: [...state.specialAssignmentsServed, action.payload],
            };
        ...
        case "edit_special_assignment_served":
            return {
                ...state,
                specialAssignmentsServed: Object.assign([], state.specialAssignmentsServed, {
                    [action.payload.index]: action.payload.specialAssignment
                })
            };

        case "delete_special_assignment_served":
            return {...state, specialAssignmentsServed: [...state.specialAssignmentsServed.filter(item => item !== action.payload.specialAssignment)] };
...
const addSpecialAssignmentServed = (dispatch) => {
    return (specialAssignment) => {
        dispatch({ type: "add_special_assignment_served", payload: specialAssignment });
    };
};
...
export const { Context, Provider } = createDataContext(
    experiencesReducer, {
        ...
        specialAssignmentsServed: ["sjfhslhfsljdf", "jdfksjdfkjdsf", "kjadfksjdfkjdf"],
